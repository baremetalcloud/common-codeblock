...
internal inline fun buildCodeString(crossinline builderAction: CodeWriter.() -> Unit): String {
...
//    }
    ...
    inline fun emitInto(out: Appendable, crossinline action: CodeWriter.() -> Unit) {
